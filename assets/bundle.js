...
exports.Render = async () => {
	let repos;
	try {
		const response = await axios.get("https://api.github.com/users/yefcode/repos");
...
$("#contact-form").submit(function (event) {
	...
	const URI = `mailto:yefcode@gmail.com?subject=Portfolio%20Contact:%20${encodeURIComponent(fname)}%20${encodeURIComponent(lname)}&body=${encodeURIComponent(subject)}`;
...
renderComponents();
},{"./components/FooterTimestamp":28,"./components/GitHubButtons":29,"./components/RepoList":30,"./components/SlideShow":31}]},{},[32]);
